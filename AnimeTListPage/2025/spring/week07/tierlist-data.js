const tierlistData = {
  ...
  content: "The mid-season tier highlight definitely revolves around the sub-top tiers like A, B, and C. While SS, S, and D are pretty much locked in, mid-tier titles such as <span class=\"anime-title\">Mobile Suit Gundam GQuuuuuuX</span>, <span class=\"anime-title\">Kowloon Generic Romance</span>, and <span class=\"anime-title\">From the Old Country Bumpkin...</span> are still holding some potential to rise — though honestly, they're quite wobbly. From my personal view, Gundam and From the Old... have finally started showing some of their own charm, though not fully baked yet. Hopefully they'll offer a bit more than what we saw back in Episode 1.\nMid-season shifts mainly appear in the mid-tiers — A, B, and C — where some titles keep wobbling while showing small flashes of potential. For now, shows like <span class=\"anime-title\">Mobile Suit Gundam GQuuuuuuX</span>, <span class=\"anime-title\">Kowloon Generic Romance</span>, and <span class=\"anime-title\"><span class=\"anime-title\">From the Old Country Bumpkin...</span> are still hanging in there, slightly improving but not fully convincing yet. I hope the next few episodes will give them more room to settle and show stronger direction.",
