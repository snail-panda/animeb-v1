const tierlistData = {
  ...
  content: "The mid-season tier highlight definitely revolves around the sub-top tiers like A, B, and C. While SS, S, and D are pretty much locked in — with  <span class=\"anime-title\">The Apothecary Diaries Second Season</span>,  <span class=\"anime-title\">Sword of the Demon Hunter</span>, and  <span class=\"anime-title\">Shoshimin: How to Become Ordinary 2</span> absolutely dominating the top, and certain bottom-tier shows still proudly claiming their D-tier status —the real action lies in the middle.<br>Mid-tier titles such as  <span class=\"anime-title\">Mobile Suit Gundam GQuuuuuuX</span>,  <span class=\"anime-title\">Kowloon Generic Romance</span>, and  <span class=\"anime-title\">From the Old Country Bumpkin to Master Swordsman... </span>are still holding some potential to rise — though honestly, they're quite wobbly. From my personal view, Gundam and From the Old... have finally started showing some of their own charm, though not fully baked yet. And the thing is — back in Episode 1, these were among the shows I was really excited about. I hope the next few episodes will give them the push they need to live up to that early promise.",
  ...
  tierImage: "../../../../images/tier-lists/2025/spring/2025midspring-tier-list-ep7-8.png",
  tierGuide: `
